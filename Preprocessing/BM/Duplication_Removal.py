...
# Load the CSV file
file_path = 'Integrated_Political_BM_News.csv'  # 'Integrated_Political_EN_News.csv'
...
output_path = 'Integrated_Political_BM_News_deduced.csv'  # 'Integrated_Political_EN_News_deduced.csv'
