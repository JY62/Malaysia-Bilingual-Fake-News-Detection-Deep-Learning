...
#
# # Load the dataset
# df = pd.read_csv('Log/Processed_Dataset_BM.csv')
#
#
...
# plt.axis('off')
# plt.title('Word Cloud for Malaysia Malay Political News')
# plt.show()
...
# )
#
# plt.title('Distribution of Real and Fake News in Malay', pad=20)
# plt.axis('equal')
# plt.show()
...
# plt.title('Sentence Length Distribution for BM News Titles')
...
# plt.xticks(rotation=45)
# plt.title('Sentence Length Distribution for BM News Full Contexts')
# plt.ylabel('Number of Tokens')
# plt.xlabel('Category')
# plt.show()
...
# plt.title('Average Word Length Distribution in BM Dataset')
...
# plt.title('Total Number of Unique Words in BM Dataset')
