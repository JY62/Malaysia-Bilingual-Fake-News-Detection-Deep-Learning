...
def word_level_attention(inputs, maxlen, name_prefix, hp):
    ...
    # Sequence Encoding with Bi-LSTM (Get number of LSTM layers from hyperparameters)
    ...
    # Stack multiple LSTM layers based on hyperparameter
    for i in range(num_lstm_layers):
        ...
        # Add dropout between LSTM layers with unique names
...
def build_model(hp):
    # Input layers with correct shapes
    ...
    # Process title and context separately with the same hyperparameters
    ...
    for i in range(num_dense_layers):
        # Use unique names for dense and dropout layers
        x = Dense(
