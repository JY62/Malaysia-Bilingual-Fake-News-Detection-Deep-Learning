...
X_combined_balanced = np.array(X_combined_balanced)
y_balanced = np.array(y_balanced)

# Print the number of records of each class after downsampling
...
# Split the dataset (use the balanced dataset)
...
# Padding sequences after splitting
max_length = 1000
...
class_weights = {0: 1.0, 1: len(y_balanced[y_balanced == 0]) / len(y_balanced[y_balanced == 1])}
